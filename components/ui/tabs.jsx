...
const TabsList = React.forwardRef(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-center xl:bg-white p-1 bg-muted text-muted-foreground rounded-[30px] dark:md:bg-secondary",
      className
    )}
    {...props} />
))
